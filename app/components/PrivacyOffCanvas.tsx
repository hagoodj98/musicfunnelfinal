    ...
    <div>
      ...
      <Drawer anchor={placement} open={show} onClose={handleClose}>
        ...
        <div className="bg-lighterblue text-white">
          ...
          <p>
            Welcome to jaiquezmusic.com (referred to as “we,” “our,” or “us”).
            This Privacy Policy explains how we collect, use, store, and share
            your personal information when you use our website and services (the
            “Services”). Our aim is to protect your privacy while providing you
            with an engaging music fan experience.
          </p>
          ...
          <ul>
            ...
            <li>
              • Security and Session Management: We create, update, and refresh
              sessions using tokens stored in Redis. This ensures that only
              authenticated and subscribed users can access protected areas.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              • Redis: To manage session data (this data is stored securely on
              our servers and not shared with third parties).
            </li>
            <li>
              {" "}
          ...
          <p>
            ...
            Redis expires automatically based on your “remember me” selection
            (either about 1 hour or up to 1 week).
          </p>
          <h3 className="font-header">6. Your Rights</h3>
          <ul>
            <li>
              {" "}
              • Access and Update: You may request access to, correction of, or
              deletion of your personal data by contacting us at [Your Contact
              Email].
            </li>
            <li>
          ...
          <p>
            ...
            please contact us at: Email: jaiquezmanage98@gmail.com
          </p>
        </div>
      </Drawer>
    </div>
