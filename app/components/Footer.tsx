    ...
    <footer className=" border-t border-yellow/15 bg-lighterblue">
      <div className="container mx-auto flex flex-col gap-8 px-6 py-8 md:flex-row md:items-start md:justify-between">
        <div className="flex flex-col items-center text-center md:items-start md:text-left">
          ...
          <Link
            className="font-header text-4xl leading-none text-white no-underline transition hover:text-yellow"
            href="/"
          >
            @JH Studios
          </Link>
          ...
          <div className="mt-2 flex items-center font-header text-base text-white sm:text-lg">
            <Metafooter name="Privacy Policy" placement="left">
              ...
              <p>
                ...
                and share your personal information when you use our website and
                services (the “Services”). Our aim is to protect your privacy
                while providing you with an engaging music fan experience.
              </p>
              ...
              <ul>
                <li>
                  ...
                  subscribe you to our mailing list via Mailchimp and to manage
                ...
                <li>
                  • Communication: We may send you updates, promotional emails,
                  or notifications about your account or subscription status.
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  • Redis: To manage session data (this data is stored securely
              ...
              <p>
                ...
                provide our Services or as required by law. Session data stored
                in Redis expires automatically based on your “remember me”
              ...
              <ul>
                <li>
                  ...
                  or deletion of your personal data by contacting us at [Your
                  Contact Email].
                </li>
                <li>
            ...
            <Metafooter name="Terms of Use" placement="left">
              ...
              <p>
                ...
                to these Terms of Service (“Terms”). If you do not agree, please
                do not use the Site.
              </p>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      ...
                      engage in data scraping, or otherwise misuse our Services.
                    </li>
                  </ul>
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  ...
                  <ul>
                    <li>
                      • All purchases are processed through Stripe. By making a
                      payment, you agree to Stripe’s terms in addition to these
                      Terms.
                    </li>
                  </ul>
                </li>
              ...
              <p>
                All content on the Site—including text, images, logos, and other
                materials—is owned by or licensed to [Your Site Name]. You may
                not reproduce or distribute any part of the Site without our
