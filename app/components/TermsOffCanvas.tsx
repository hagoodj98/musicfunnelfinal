...
function TermsOffCanvas({ name, placement }) {
  ...
  return (
    <div>
      <button
        onClick={handleShow}
        className="me-2  custom-footer-button"
        style={{ color: "white" }}
      >
        {name}
      </button>
      <Drawer anchor={placement} open={show} onClose={handleClose}>
        ...
        <div className="bg-lighterblue text-white">
          ...
          <p>
            By accessing or using jaiquezmusic.com (the “Site”), you agree to
          ...
          <p>
            ...
            jurisdiction) to use our Services. By using the Site, you represent
          ...
          <ul>
            <li>
              ...
              license to access and use our Site for personal, non-commercial
              purposes.
            </li>
            <li>
              ...
              <ul>
                ...
                <li>
                  {" "}
                  • You must keep your session credentials secure. Any activity
            ...
            <li>
              ...
              <ul>
                <li>
                  • Do not attempt to disrupt the Site’s functionality, engage
                  in data scraping, or otherwise misuse our Services.
                </li>
              </ul>
            </li>
          </ul>
          ...
          <ul>
            <li>
              ...
              <ul>
                <li>
                  {" "}
                  • By subscribing, you agree to receive communications (such as
                  emails from Mailchimp) related to our services.
                </li>
                <li>
                  • Your subscription status is managed via secure tokens stored
                  in Redis.
                </li>
              </ul>
            </li>
          ...
          <p>
            ...
            materials—is owned by or licensed to [Your Site Name]. You may not
          ...
          <p>
            You agree to indemnify and hold harmless [Your Site Name] and its
            affiliates from any claims, damages, or losses resulting from your
